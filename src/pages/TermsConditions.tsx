...
const blocks: LegalBlock[] = [
  ...
  {
    type: "p",
    content: "Titular y prestador del servicio: REY ACADEMY, cuyo correo electrónico de contacto es contacto@reyacademy.com.",
  },
  {
    type: "p",
    content:
  ...
  { type: "h2", text: "9. Derecho de revocación y política de reembolso" },
  {
    type: "p",
    content:
      "Cuando la normativa de defensa del consumidor aplicable reconozca al Estudiante un derecho de revocación o arrepentimiento por contratación a distancia, este podrá ejercerlo dentro del plazo legal que dicha normativa establezca desde la contratación, comunicándolo por escrito a contacto@reyacademy.com.",
  },
  {
    type: "p",
    content:
  ...
  { type: "h2", text: "24. Reclamaciones, ley aplicable y jurisdicción" },
  {
    type: "p",
    content:
      "Antes de iniciar cualquier acción, invitamos al Estudiante a comunicarse con nosotros en contacto@reyacademy.com para procurar una solución de buena fe. Atenderemos las reclamaciones en el plazo que resulte razonable conforme a la normativa aplicable.",
  },
  {
    type: "p",
    content:
