...
const blocks: LegalBlock[] = [
  ...
  },
  {
    type: "p",
    content:
      "Responsable del tratamiento: REY ACADEMY, cuyo correo electrónico de contacto en materia de privacidad es info@mg.reyacademy.com.",
  },
  {
    type: "p",
    content:
  ...
  },
  {
    type: "p",
    content:
      'Puedes revocar tu consentimiento en cualquier momento escribiéndonos a info@mg.reyacademy.com, utilizando el enlace de baja incluido en nuestros correos electrónicos o respondiendo con la palabra "BAJA" en nuestros canales de mensajería. La revocación se hará efectiva en un plazo razonable y no afectará a las comunicaciones estrictamente necesarias para la ejecución de un programa que tengas contratado.',
  },
  ...
  { type: "h3", text: "21.1. Cómo ejercer tus derechos" },
  {
    type: "p",
    content:
      "Escríbenos a info@mg.reyacademy.com indicando tu nombre completo, el correo electrónico asociado a tu registro y el derecho que deseas ejercer. Podremos solicitarte información adicional para verificar tu identidad, con la única finalidad de proteger tus propios datos.",
  },
  {
    type: "p",
    content:
