/**
 * Topography — React Bits (https://reactbits.dev) · MIT License
...
const Topography = ({
  ...
  useEffect(() => {
    ...
    // Con varias instancias de Topography en una misma página (varias
    // secciones "de marca"), cualquier excepción de un solo frame sin
    // capturar mataría ese loop para siempre — mismo bug ya encontrado y
    // corregido en DitherField. try/finally asegura que el rAF siempre se
    // vuelva a programar pase lo que pase dentro del frame.
    const loop = t => {
      try {
        ...
        console.error('Topography: frame descartado por error, el loop continúa', err);
      } finally {
