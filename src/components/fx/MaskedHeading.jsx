/**
 * MaskedHeading — React Bits (https://reactbits.dev) · MIT License
    ...
    >
      ...
      <span ref={revealRef} className="masked-heading__reveal">
        <span className="masked-heading__clip" style={{ clipPath: `url(#${clipId})` }}>
          {baseColor && (
            <span className="masked-heading__base" style={{ backgroundColor: baseColor }} />
          )}
          <span
            ref={mediaRef}
            className="masked-heading__media"
            style={baseColor ? { mixBlendMode: blendMode } : undefined}
          >
            {mediaType === 'video' ? (
