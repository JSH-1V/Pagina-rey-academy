    ...
    <div className="bg-background text-on-surface font-sans overflow-x-hidden selection:bg-white selection:text-black">
      ...
      <section className="py-section-padding bg-primary text-background relative overflow-hidden" id="contacto">
        ...
        >
          ...
          <motion.button 
            whileHover={{ scale: 1.08, letterSpacing: "0.32em", boxShadow: "0 20px 40px rgba(0,0,0,0.3)" }}
            whileTap={{ scale: 0.95 }}
            className="bg-background text-primary px-8 sm:px-16 py-5 sm:py-8 font-label-caps text-[13px] sm:text-[18px] font-extrabold tracking-[0.15em] sm:tracking-[0.3em] rounded-full w-full sm:w-auto cursor-pointer shadow-2xl"
          >
            RESERVAR ENTREVISTA
          </motion.button>
        </motion.div>
